...
import cv2
import math
from craftocr.imgproc import loadImage
...
def getDetBoxes_core(textmap, text_threshold, low_text):
    # prepare data
    ...
    for k in range(1, nLabels):
        ...
        for contour in contours:
            if cv2.contourArea(contour) < 10: continue  # adjust this threshold as needed
...
def getDetBoxes(textmap, linkmap, text_threshold, link_threshold, low_text, poly=False):
    boxes, labels, mapper, det_scores = getDetBoxes_core(textmap, text_threshold, low_text)
    # print(mapper)
    if poly:
